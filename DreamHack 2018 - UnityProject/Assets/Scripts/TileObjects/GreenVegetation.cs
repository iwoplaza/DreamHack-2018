...
{
    public class GreenVegetation : TileObjectBase 
    {

        public override bool IsStatic { get { return true; } }
        public override string DisplayName { get { return "Green type vegetation"; } }
        ...
        public override void ConstructGameObject()
        {
            ...
            GameObject prefab = WorldPopulationResource.GetResources(WorldPopulationResource.PopulationType.VEGETATION_GREEN);
            if (prefab != null)
            {
